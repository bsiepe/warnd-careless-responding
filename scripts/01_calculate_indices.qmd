...
Above, we defined the main default cutoffs that we use for the paper. We now check how many responses are marked as careless for each of the indices (in percent of all responses):
```{r}
...
column_order <- c("Avg. RT", "SD RT", "SD within", "Longstring", "Mode", "Antonym", "LPA", "IRT", "Single", "Double")
