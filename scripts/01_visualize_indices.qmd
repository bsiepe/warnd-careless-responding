...
We attach the model results to the indices. We classify everyone with an LPA profile 2, and a mixture IRT class 1 as attentive. 
```{r}
#| label: attach-model
